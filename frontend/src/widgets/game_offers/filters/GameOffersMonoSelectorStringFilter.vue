...
import type { IGameOffersMonoSelectorStringFilterProps } from '@/features/filters/interface/FilterUI'
...
const props = defineProps<IGameOffersMonoSelectorStringFilterProps>()
